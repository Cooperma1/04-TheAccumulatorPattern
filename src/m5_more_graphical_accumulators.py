...
def run_test_draw_circles_from_rectangle():
    ...
    ###########################################################################
    # -------------------------------------------------------------------------
    title = 'Tests 1 of DRAW_CIRCLES_FROM_RECTANGLES:'
    window1 = rg.RoseWindow(720, 550, title)
    ...
    title = 'Test 2 of DRAW_CIRCLES_FROM_RECTANGLES:'
...
def draw_circles_from_rectangle(m, n, rectangle, window):
    ...
    for k in range(m):
        circle = rg.Circle(
            rg.Point(rectangle.get_lower_left_corner().x - height * (1 / 2 + k), rectangle.get_center().y), height / 2)
...
def draw_lines_from_rectangles(rectangle1, rectangle2, n, window):
    ...
    for k in range(n):
        ...
        ypoint = rg.Point(center2.x - k / 2 * width1, center2.y + k / 2 * height)
